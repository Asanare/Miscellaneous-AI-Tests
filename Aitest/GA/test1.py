...
def rankPop (chromos):
  ...
  pairedPop = list(zip ( chromos, proteins, outputs, fitnessScores)) # pair each chromo with its protein, ouput and fitness score
...
def iteratePop (rankedPop):
  ...
  newpop = []
  newpop.extend(rankedChromos[:int(popN/15)]) # known as elitism, conserve the best solutions to new population
